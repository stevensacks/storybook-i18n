...
- chore: replace release.yml with npmpublish.yml as per storybook addon kit ([@stevensacks](https://github.com/stevensacks))
...
# v4.0.3 (Fri May 23 2025)

#### ⚠️ Pushed to `main`

- feat: upgrade deps ([@stevensacks](https://github.com/stevensacks))
- fix: use npm not yarn ([@stevensacks](https://github.com/stevensacks))
...
- chore: storybook's packageManager ([@stevensacks](https://github.com/stevensacks))
